...
const title = ref<string | any>('Modal Page')
const description = ref<string>('Modal Page Description')
useHead({
  title,
  meta: [{
    name: 'description',
...
<template>
  <div>
    <button class="rounded-lg bg-blue-300 dark:bg-blue-500 p-4" @click="open = !open">
      Open Modal
    </button>
