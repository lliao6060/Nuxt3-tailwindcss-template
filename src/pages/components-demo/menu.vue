    ...
    <div class="fixed top-16 w-56">
      <Menu as="div" class="relative inline-block text-left">
        <div>
          ...
          >
            Options
            <Icon icon="material-symbols:arrow-drop-down" class="ml-2" />
          </MenuButton>
        </div>
          ...
          >
            <div class="px-1 py-1">
              <MenuItem v-slot="{ active }">
                ...
                >
                  <Icon icon="ic:outline-edit" class="mr-2" />
                  Edit
                </button>
              </MenuItem>
              <MenuItem v-slot="{ active }">
                ...
                >
                  <Icon icon="iconoir:copy" class="mr-2" />
                  Copy
                </button>
              </MenuItem>
            </div>
            <div class="px-1 py-1">
              <MenuItem v-slot="{ active }">
                ...
                >
                  <Icon icon="mdi:file-document-multiple-outline" class="mr-2" />
                  File
                </button>
              </MenuItem>
            </div>
